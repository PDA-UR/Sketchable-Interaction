...
bool ros2_si_interface__msg__vtksi_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_si_interface.msg._vtksi_object.VTKSIObject", full_classname_dest, 47) == 0);
  }
  ros2_si_interface__msg__VTKSIObject * ros_message = _ros_message;
  {  // id
  ...
  {  // plugin
    PyObject * field = PyObject_GetAttrString(_pymsg, "plugin");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->plugin, PyBytes_AS_STRING(encoded_field));
  ...
  {  // geometry
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->geometry.data;
  ...
  {  // click
    PyObject * field = PyObject_GetAttrString(_pymsg, "click");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->click = (Py_True == field);
    Py_DECREF(field);
  }
  {  // drag
  ...
  {  // links
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->links.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
  ...
  {  // tracker_dimension_x
    PyObject * field = PyObject_GetAttrString(_pymsg, "tracker_dimension_x");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->tracker_dimension_x = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // tracker_dimension_y
    PyObject * field = PyObject_GetAttrString(_pymsg, "tracker_dimension_y");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
...
{
  /* NOTE(esteve): Call constructor of VTKSIObject */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_si_interface.msg._vtksi_object");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VTKSIObject");
  ...
  {  // plugin
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->plugin.data,
      strlen(ros_message->plugin.data),
      "strict");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "plugin", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // geometry
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "geometry");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->geometry.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->geometry.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->geometry.size * sizeof(float));
      assert(data != NULL);
  ...
  {  // click
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->click ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "click", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // links
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "links");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->links.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->links.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->links.size * sizeof(int32_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // tracker_dimension_x
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->tracker_dimension_x);
    {
      int rc = PyObject_SetAttrString(_pymessage, "tracker_dimension_x", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // tracker_dimension_y
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->tracker_dimension_y);
    {
      int rc = PyObject_SetAttrString(_pymessage, "tracker_dimension_y", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
